        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              <h2 className="text-sm title-font text-violet-200 tracking-widest">
                {item.title}
              </h2>
              <h1 className="text-violet-300 text-3xl title-font font-medium mb-4">
                {item.location}
              </h1>
              <div className="flex mb-4">
                <a className="flex-grow text-violet-400 border-b-2 border-violet-400 py-2 text-lg px-1">
                  Description
                </a>
              </div>
              <p className="leading-relaxed mb-4 text-violet-100">
                {item.description}
              </p>
              ...
              <div className="flex border-t border-b mb-6 border-slate-200 py-2">
                ...
                <span className="ml-auto text-violet-300">
                  {item.vacancy === true && item.rooms.length
                    ? "Yes"
                    : "No Vacancy"}
                </span>
              </div>
              <div className="flex flex-col border-t mb-6 border-slate-200 py-2">
                {item.vacancy === true && item.rooms.length ? (
                  <>
                    <h1 className="text-violet-300 text-xl font-bold text-center">
                      Select Room
                    </h1>
              ...
              {item.vacancy === true && item.rooms.length ? (
                <div className="flex">
                  <span
                    className="title-font font-medium text-2xl text-violet-400"
                    id="total"
                  >
                    $ 0.00
                  </span>
